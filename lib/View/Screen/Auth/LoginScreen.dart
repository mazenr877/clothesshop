...
import 'package:asroshop/View/Screen/Auth/ForgotScreen.dart';
import 'package:asroshop/View/Screen/Auth/SignupScreen.dart';
import 'package:asroshop/View/Screen/MainScreen.dart';
import 'package:asroshop/View/Widget/ReusableWdget/Container.dart';
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      GetBuilder<HomePage>(
                        init: HomePage(),
                        builder: (controller) => inkwell_check(),
                      ),
                      SizedBox(height: 30),
                      GetBuilder<HomePage>(
                        init: HomePage(),
