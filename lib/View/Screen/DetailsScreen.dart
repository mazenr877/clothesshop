...
import 'package:asroshop/View/Widget/AddCart.dart';
import 'package:asroshop/View/Widget/SizeShirt.dart';
import 'package:badges/badges.dart' as badges;
import 'package:asroshop/Utils/Constant/ConstantColor.dart';
import 'package:asroshop/View/Screen/CardItem.dart';
import 'package:asroshop/View/Widget/ImagePicker.dart';
...
class _DetailsState extends State<Details> {
  ...
  List<Color> ListColor = [color1, color2, color3, color4, color5];
  int inde = 0;
  int page = 0;
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              MaterialButton(
                                onPressed: () {
                                  controller.MangeFavorite(widget.modelapi.id);
                                },
                                child: CircleAvatar(
                                  ...
                                  radius: 14,
                                  child:
                                      controller.AddFavorite(widget.modelapi.id)
                                      ? const Icon(
                                          Icons.favorite,
                                          size: 17,
                                          color: Colors.red,
                          ...
                          SizeShirt(),
                          AddCart(modelapi: widget.modelapi),
                        ],
                      ),
                    ),
                  ),
